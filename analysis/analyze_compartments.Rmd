...
## Reclustering compartments and comparative analysis of immune lineages between TGFb high/low
...
# TGFbELISA
table(immune_seurat$TGFbELISA)
immune_seurat_tgfb <- subset(immune_seurat, subset = TGFbELISA %in% c("HighTGFb", "LowTGFb"))

table(immune_seurat_tgfb$TGFbELISA, immune_seurat_tgfb$celltype)
