...
make_data <- function(seurat_object){
  ...
  write.table(cellAnnotations, file=paste0("/scratch/hnatri/CART/infercnv/seurat_data_cellAnnotations_SampleKOWT.txt"),
              sep= "\t", quote = F)
  
  write.table(round(singleCell.counts.matrix, digits=3), 
              file=paste0("/scratch/hnatri/CART/infercnv/seurat_data_singleCell.counts.matrix_SampleKOWT"), quote=F, sep="\t")
}
...
run_infercnv <- function(){
  ...
  infercnv_obj <- CreateInfercnvObject(raw_counts_matrix=paste0("/scratch/hnatri/CART/infercnv/seurat_data_singleCell.counts.matrix_SampleKOWT"),
                                       annotations_file=paste0("/scratch/hnatri/CART/infercnv/seurat_data_cellAnnotations_SampleKOWT.txt"),
                                       delim="\t",
                                       gene_order_file="/home/hnatri/13384_CART/13384_Tumors/gene_ordering_file.txt", # this file has geneID, chr, start, end
                                       ref_group_names=c("HD680_WT", "HD562_WT", "HD624_WT"),
  ...
  infercnv_obj <- infercnv::run(infercnv_obj,
                                ...
                                out_dir=paste0("/scratch/hnatri/CART/infercnv/seurat_data_HMMi3_samplelevel_refgroup_output/"),  # dir is auto-created for storing outputs
  ...
  saveRDS(infercnv_obj, file = paste0("/scratch/hnatri/CART/infercnv/seurat_data_HMMi3_samplelevel_refgroup.rds"))
  ...
  plot_cnv(infercnv_obj,
           ...
           output_filename=paste0("seurat_data_HMMi3_samplelevel_refgroup.res"),
           output_format="pdf",
           #k_obs_groups = 5,
           dynamic_resize=0)
  ...
  annot <- read.table(paste0("/scratch/hnatri/CART/infercnv/seurat_data_cellAnnotations_SampleKOWT.txt"))
  #selected <- WhichCells(seurat_data, idents = cluster)
  ...
  seurat_subset <- infercnv::add_to_seurat(infercnv_output_path=paste0("/scratch/hnatri/CART/infercnv/seurat_data_HMMi3_samplelevel_refgroup_output/"),
  ...
  saveRDS(seurat_subset, file = paste0("/scratch/hnatri/CART/infercnv/seurat_data_infercnv_HMMi3_samplelevel_refgroup_seurat.rds"))
