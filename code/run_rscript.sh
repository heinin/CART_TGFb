#!/bin/bash
#SBATCH --job-name=rscript_cart # Job name
...
# /packages/containers/RStudio/rstudio-with_modules-4.4.0-2.sif InferCNV
export SIMG_FILE_NAME=rstudio-with_modules-4.4.0-2.sif
...
RSTUDIO_PASSWORD=$PASSWORD singularity exec -B /tgen_labs,/opt,$RSTMP:/tmp,$RSLIB:/var/lib/rstudio-server/,$RSRUN:/var/run/rstudio-server/,${RPRIHOME}/.Renviron:$HOME/.Renviron,${RPRIHOME}/.rstudio:$HOME/.rstudio,${RPRIHOME}/.config:$HOME/.config $SIMG_IMAGE R CMD BATCH inferCNV_alldata_definenorm_samplelevel.R
